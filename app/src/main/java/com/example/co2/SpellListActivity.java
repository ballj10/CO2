...
import com.example.co2.dummy.DummyContent;
...
public class SpellListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.spell_list);
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(SpellDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(SpellDetailFragment.ARG_ITEM_ID, item.id);
